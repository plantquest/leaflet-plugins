...
`
  ...
  pointInPolygon: function (point: any, vs: any, start: any, end: any) {
  ...
  pointInPolygonFlat: function (point: any, vs: any, start: any, end: any) {
    let x = point[0],
      y = point[1]
    let inside = false
  ...
  pointInPolygonNested: function (point: any, vs: any, start: any, end: any) {
    let x = point[0],
      y = point[1]
    let inside = false
    if (start === undefined) start = 0
  ...
  convertRoomPoly: function (img: any, poly: any) {
  ...
  convert_latlng: function (latlng: any) {
    let rc = new RasterCoords({ map: null, imgsize: null })
  ...
  convert_poly_y: function (img: any, y: any) {
    return img[1] - y
  },

  c_asset_coords: function (x: any, y: any) {
    let rc = new RasterCoords({ map: null, imgsize: null })
